...
- `aspect_ratio`:
  ...
  - `full_screen` Resize camera image to NN input size and display a maximized image. See [Aspect Ratio Mode](../../application_code/semantic segmentation/STM32N6/Doc/Build-Options.md#aspect-ratio-mode)
- `color_mode`:
  - `rgb`
  - `bgr`
