...
stedgeai generate --model <supported_model> --target stm32n6 --st-neural-art default@user_neuralart_NUCLEO-N657X0-Q.json --input-data-type uint8 --output-data-type uint8 --inputs-ch-position chlast --outputs-ch-position chlast
