...
stedgeai generate --model st_movenet_lightning_heatmaps_192_int8_pc.tflite --target stm32n6 --st-neural-art default@user_neuralart_STM32N6570-DK.json --input-data-type uint8
